...
{
    public record GetAllTechnicianAvailabilitiesByTechnicianIdQuery(string technicianId) : IRequest<Response<List<GetAllTechnicianAvailabilitiesByTechnicianIdResult>>>;
}
