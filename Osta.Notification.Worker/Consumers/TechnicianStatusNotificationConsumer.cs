...
{
    public class TechnicianStatusNotificationConsumer : BackgroundService
    {
        private readonly ConnectionFactory _factory;

        private readonly IServiceScopeFactory scopeFactory;

        public TechnicianStatusNotificationConsumer(IServiceScopeFactory scopeFactory)
        {
        ...
        protected async override Task ExecuteAsync(CancellationToken cancellationToken)
        {
            ...
            consumer.ReceivedAsync += async (model, eventArgs) =>
            {
                try
                {
                    ...
                    var notification =
                        JsonSerializer.Deserialize<TechnicianStatusNotificationMessage>(message);
            ...
            Console.WriteLine("technician request  Consumer is waiting for messages...");
